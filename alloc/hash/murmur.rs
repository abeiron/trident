...
pub fn murmur_32(key: &impl AsRef<[u8]>) -> u32
{
  #[inline]
  ...
  let mut h1 = Wrapping(0u32); // The seed.
  ...
  let blocks = unsafe { slice::from_raw_parts(key.as_ptr() as *const Wrapping<u32>, nblocks) };
