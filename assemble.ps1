...
foreach ($ext in $extension_sets) {
    riscv64-unknown-elf-gcc -ggdb3 -fdebug-prefix-map=$pwd=/trident -c -mabi=ilp32 -march=rv32$ext asm.S -o bin/$crate.o
    riscv64-unknown-elf-ar crs bin/riscv32$ext-unknown-none-elf.a bin/$crate.o

    riscv64-unknown-elf-gcc -ggdb3 -fdebug-prefix-map=$pwd=/trident -c -mabi=lp64 -march=rv64$ext asm.S -o bin/$crate.o
